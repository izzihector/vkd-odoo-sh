...
class ResUsers(models.Model):
    ...
    azure_ad_calendar_id = fields.Many2one(string='Outlook Calendar', comodel_name='azure.ad.calendar', related='azure_ad_user_id.calendar_id')
    azure_ad_calendar_ignore_without_category = fields.Boolean(string='Only Sync Calendar Items With Category', related='azure_ad_user_id.calendar_ignore_without_category')
    azure_ad_calendar_sync_failed = fields.Boolean(string='Calendar Sync Has Failed', related='azure_ad_user_id.calendar_sync_failed')
    ...
    def aad_setup(self):
        ...
        if not self.azure_ad_calendar_id:
            self.azure_ad_user_id.reload_calendar_options()
