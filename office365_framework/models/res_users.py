...
class ResPartner(models.Model):
    ...
    aad_email = fields.Char(string="Azure AD Email", related='azure_ad_user_id.email')
    outlook_category = fields.Char('Outlook Category', related='azure_ad_user_id.outlook_category')
    azure_ad_sync_started = fields.Boolean(string='Synchronisation of Azure', related='azure_ad_user_id.azure_ad_sync_started')
    azure_ad_authentication_failure = fields.Boolean(string='Authentication Failure', related='azure_ad_user_id.authentication_failure')
    azure_ad_last_error = fields.Char(string="Last Error", related='azure_ad_user_id.last_error')
    azure_ad_last_sync = fields.Char(string="Last Sync", related='azure_ad_user_id.last_sync')


class ResUsers(models.Model):
    _inherit = 'res.users'

    # azure_ad_user_id = fields.One2many(string='Azure AD User', related='partner_id.azure_ad_user_id')
    azure_ad_allow_ad_login = fields.Boolean(string='Allow Azure AD login', related='company_id.aad_oauth_enabled')
